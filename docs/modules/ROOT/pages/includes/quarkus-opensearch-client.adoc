...
a| [[quarkus-opensearch-client_quarkus-opensearch-health-check-enabled]] [.property-path]##link:#quarkus-opensearch-client_quarkus-opensearch-health-check-enabled[`quarkus.opensearch.health-check.enabled`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.opensearch.health-check.enabled+++[]
endif::add-copy-button-to-config-props[]


`quarkus.opensearch."client-name".health-check.enabled`
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.opensearch."client-name".health-check.enabled+++[]
endif::add-copy-button-to-config-props[]

[.description]
--
Whether this client should be included in health checks. When set to false, this client will be excluded from the OpenSearch health check endpoint.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_OPENSEARCH_HEALTH_CHECK_ENABLED+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_OPENSEARCH_HEALTH_CHECK_ENABLED+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++true+++`
