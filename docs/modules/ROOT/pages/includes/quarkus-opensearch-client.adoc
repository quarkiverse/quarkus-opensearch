...
a| [[quarkus-opensearch-client_quarkus-opensearch-health-enabled]] [.property-path]##link:#quarkus-opensearch-client_quarkus-opensearch-health-enabled[`quarkus.opensearch.health.enabled`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.opensearch.health.enabled+++[]
endif::add-copy-button-to-config-props[]


`quarkus.opensearch."client-name".health.enabled`
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.opensearch."client-name".health.enabled+++[]
endif::add-copy-button-to-config-props[]
